(()=>{function h(n,e){!n||["playing","pause","ratechange","seeked"].forEach(o=>{n.addEventListener(o,e)})}function v(n){let e=n.querySelector("video");if(e)return e;let o=document.body.querySelectorAll("video"),t=document.querySelector("audio");return t||o[0]}function E(n){let e=document.querySelector("audio");if(e)return n(e);["fullscreenchange","webkitfullscreenchange","mozfullscreenchange","MSFullscreenChange"].forEach(o=>document.addEventListener(o,n))}var x=0;function B(n){return n.currentTime>0&&!n.paused&&!n.ended&&n.readyState>2}function b(n){let e=new Date().getTime();if(e-x<100)return!1;x=e;let o=e,t=B(n),s=n.currentTime,a=n.playbackRate,r={playing:t,vidCurTime:s,curTime:o,playbackRate:a};return JSON.stringify(r)}function w(n,e){let{vidCurTime:o,playbackRate:t,curTime:s,playing:a}=n;if(!s||s<x)return;let r=new Date().getTime();x=r;let p=(r-s)/1e3,l=o+t*p,c=B(e);a?(Math.abs(e.currentTime-l)>500&&(e.currentTime=l),c||(e.play(),e.currentTime!==l&&(e.currentTime=l))):(e.currentTime!==o&&(e.currentTime=o),c&&e.pause()),e.playbackRate!==n.playbackRate&&(e.playbackRate=n.playbackRate)}var A=5e3,M="https";async function q(n){let e;function o(t,s){if(!s||!t)return r=>r;let a=s.toUpperCase();return e&&clearInterval(e),e=setInterval(()=>{fetch(`${M}://${n}/?method=get&room=${a}`).then(r=>r.json()).then(r=>w(r,t))},A),r=>{let p=b(t);p&&fetch(`${M}://${n}/?method=send&room=${a}&data=${p}`)}}try{let s=function(a,r){if(!r||!a)return c=>c;let p=r.toUpperCase(),l=0;return t.on("message",c=>{w(JSON.parse(c),a)}),c=>{let i=b(a);i&&t.send(`${p} ${i}`)}},t=await io(`https://${n}/`);return s}catch(t){return console.log(t),o}}var _=q;async function U(n,e,o,t){if(window.JST_INITED)return;window.JST_INITED=!0,e();let s=await _(n),a=null,r=null,p=()=>a,l=i=>{a=i;let u=s(r,a);h(r,u)};E(i=>{let u=document.querySelector("audio");if(u){let d=s(u,a);h(u,d),r=u,o(document.body,p,l,u)}else{let d=document.fullscreenElement;if(!d)return t();r=v(d);let T=s(r,a);h(r,T),o(d,p,l,r)}})}var J=U;function D(n="",e=t=>t,o=t=>t){return t=>(t.innerHTML=n,t.onclick=e,o(t),t)}var m=D;var V=`<svg viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,N=O,H=R,Z=V,G=F,K=z,W={speedUp:N,speedDown:H,jstBlack:Z,checkmark:G,bug:K},f=W;function Y(n,e){return function(){let o=document.createElement("form"),t=document.createElement("button");o.classList.add("JSt-form"),o.innerHTML+=`
    <input
      minlength=6
      maxlength=6
      required
      ...
      placeholder="______"
    ></input>
    `;let s=o.querySelector("#JSt-code-input");return s.value=e(),t.classList.add("JSt-button"),t.innerHTML=f.checkmark,o.onsubmit=a=>{a.preventDefault(),n(s.value)},o.append(t),o}}var y=Y;function Q(n,e){n.innerHTML="",e.forEach(o=>{let t=document.createElement("button");t.classList.add("JSt-button"),n.append(o(t))})}var g=Q;function X(n){let e,o;switch(n.dimensions){case void 0:case"normal":e=75,o=800;break;case"big":e=85,o=900;break;case"verybig":e=100,o=1e3}let t,s,a,r,p,l,c;switch(n.color){case void 0:case"trans":r="#c8c8c8a0",a="#c8c8c8a0",s="#ffffffa0",t="#eeeeeea0",p="#e090df",l="#a44cd3",c="#8800c7";break;case"white":r="#ccd",a="#aaa",s="#fff",t="#bbbbbb",p="#888",l="#555",c="#333";break;case"black":r="#222",a="#333",s="#222222",t="#000",p="#888",l="#555",c="#333";break;case"green":r="#bfa",a="#7a6",s="#bfa",t="#8b7",p="#888",l="#555",c="#333";break;case"pink":r="#fab",a="#a67",s="#fab",t="#b78",p="#888",l="#555",c="#333";break;case"blue":r="#abf",a="#67a",s="#abf",t="#78b",p="#888",l="#555",c="#333";break}let i;switch(n["border-width"]){case void 0:case"4px":i="box-shadow: 0px 0px 10px 4px;";break;case"6px":i="box-shadow: 0px 0px 10px 6px;";break;case"10px":i="box-shadow: 0px 0px 10px 10px;"}let u=.9,d=`
.JSt-video-wrapper {
  display: flex;
  align-items: center;
...
#JSt-version {
  ...
  font-size: 0.6rem;
    ...
    `;return function(){let $=document.createElement("style");$.innerHTML=d,document.head.append($)}}var k=X;function ee(n,e){if(e){let i=document.querySelector("#JSt-pill");if(i&&i.parentNode)i.parentNode.removeChild(i);else return 0;let u=document.querySelector(".JSt-video-wrapper");u&&(u.parentNode.append(u.children.item(0)),u.remove());return}if(!n)throw new Error("couldnt init on undefined elem");if(n.nodeName==="VIDEO"){let i=document.createElement("div");i.classList.add("JSt-video-wrapper"),n.parentNode.appendChild(i);let u=()=>{if(i.requestFullscreen)return i.requestFullscreen();if(i.mozRequestFullScreen)return i.mozRequestFullScreen();if(i.webkitRequestFullScreen)return i.webkitRequestFullScreen()},d=()=>{i.appendChild(n),window.removeEventListener("click",d),window.removeEventListener("keydown",d),setTimeout(u,200)};return window.addEventListener("click",d),window.addEventListener("keydown",d),0}let o=i=>document.createElement(i),t=o("section"),s=o("div"),a=o("p"),r=o("span");t.id="JSt-pill",s.id="JSt-button-container",a.id="JSt-message",r.id="JSt-version",r.innerText=`alpha ${5}`,t.append(s),t.append(a),t.append(r),n.append(t),t.onclick=i=>i.stopPropagation();function p(){t.hidden=!0}let l;function c(){l&&clearTimeout(l),l=setTimeout(p,2e3),t.hidden=!1}return c(),document.addEventListener("click",c),document.addEventListener("mousedown",c),document.addEventListener("mousemove",c),document.addEventListener("keydown",c),[t,s,a]}var I=ee;var L=I;var S=20,te={dimensions:"normal",color:"trans","border-width":"4px"};function j(n,e,o,t){let s=m(f.jstBlack,P(n,e,o,t),i=>i.style.padding=S+"px"),a=m(f.jstBlack,P(n,e,o,t),i=>i.style.padding=S+"px"),r=m(f.speedDown,i=>{t.playbackRate>.25&&(t.playbackRate-=.25)}),p=m(f.speedUp,i=>{t.playbackRate<20&&(t.playbackRate+=.25)}),l=m(f.bug,i=>{window.open("https://jstplayer.com/feedback?from=app","_blank")});return[s,r,p,a,l]}function P(n,e,o,t){return function(a){let[r,p,l,c,i]=j(n,e,o,t),u=[m(f.jstBlack,d=>g(n,[c,p,l,i]),d=>d.style.padding=S+"px"),y(o,e)];g(n,u)}}async function ne(n,e,o,t){let s=L(n);if(!s)return;let[a,r,p]=s,[l,c,i,u,d]=j(r,e,o,t);g(r,[l,c,i,d])}function oe(){L(null,!0)}var re=k(te),C=document.createElement("script");C.src="https://cdn.socket.io/4.3.2/socket.io.min.js";C.crossorigin="anonymous";C.onerror=C.onload=n=>J("symwatch.herokuapp.com",re,ne,oe);document.body.append(C);})();
