(()=>{function h(n,e){!n||["playing","pause","ratechange","seeked"].forEach(o=>{n.addEventListener(o,e)})}function $(n){let e=n.querySelector("video");if(e)return e;let o=document.body.querySelectorAll("video"),t=document.querySelector("audio");return t||o[0]}function v(n){let e=document.querySelector("audio");if(e)return n(e);["fullscreenchange","webkitfullscreenchange","mozfullscreenchange","MSFullscreenChange"].forEach(o=>document.addEventListener(o,n))}var C=0;function E(n){return n.currentTime>0&&!n.paused&&!n.ended&&n.readyState>2}function x(n){let e=new Date().getTime();if(e-C<100)return!1;C=e;let o=e,t=E(n),s=n.currentTime,r=n.playbackRate,i={playing:t,vidCurTime:s,curTime:o,playbackRate:r};return JSON.stringify(i)}function b(n,e){let{vidCurTime:o,playbackRate:t,curTime:s,playing:r}=n;if(!s||s<C)return;let i=new Date().getTime();C=i;let l=(i-s)/1e3,p=o+t*l,c=E(e);r?(Math.abs(e.currentTime-p)>500&&(e.currentTime=p),c||(e.play(),e.currentTime!==p&&(e.currentTime=p))):(e.currentTime!==o&&(e.currentTime=o),c&&e.pause()),e.playbackRate!==n.playbackRate&&(e.playbackRate=n.playbackRate)}var A=5e3,B="https";async function q(n){let e;function o(t,s){if(!s||!t)return i=>i;let r=s.toUpperCase();return e&&clearInterval(e),e=setInterval(()=>{fetch(`${B}://${n}/?method=get&room=${r}`).then(i=>i.json()).then(i=>b(i,t))},A),i=>{let l=x(t);l&&fetch(`${B}://${n}/?method=send&room=${r}&data=${l}`)}}try{let s=function(r,i){if(!i||!r)return c=>c;let l=i.toUpperCase(),p=0;return t.on("message",c=>{b(JSON.parse(c),r)}),c=>{let a=x(r);a&&t.send(`${l} ${a}`)}},t=await io(`https://${n}/`);return s}catch(t){return console.log(t),o}}var M=q;async function U(n,e,o,t){if(window.JST_INITED)return;window.JST_INITED=!0,e();let s=await M(n),r=null,i=null,l=()=>r,p=a=>{r=a;let u=s(i,r);h(i,u)};v(a=>{let u=document.querySelector("audio");if(u){let d=s(u,r);h(u,d),i=u,o(document.body,l,p,u)}else{let d=document.fullscreenElement;if(!d)return t();i=$(d);let L=s(i,r);h(i,L),o(d,l,p,i)}})}var _=U;function D(n="",e=t=>t,o=t=>t){return t=>(t.innerHTML=n,t.onclick=e,o(t),t)}var m=D;var R=`<svg viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,V=`<svg transform="scale (-1, 1)" transform-origin="center" viewBox="0 0 128 128" fill="currentcolor">
...
`,O=`<svg viewBox="0 0 128 128" fill="currentcolor">
<path d="M106.98929,41.91644c-2.44581-2.028-4.68786-.712-6.16139.45546C93.20426,48.4096,86.782,53.14082,79.89811,58.35221,72.32216,64.08763,64.488,70.01865,56.07861,76.74553c-6.39391,5.11455-7.88014,12.12717-4.07875,19.24,1.06266,2.3214,3.55641,4.37959,6.84458,5.64816a14.19745,14.19745,0,0,0,5.13205,1.00057c4.56513,0,8.77548-2.45564,12.00228-7.1411,6.46007-9.381,11.91934-17.6315,17.6991-26.36671,4.51071-6.817,8.47925-13.20849,13.63935-20.80625C108.96047,45.90074,108.83486,43.447,106.98929,41.91644Z"/>
<path d="M64.00244,38.07609a49.13226,49.13226,0,0,1,18.55737,5.44938c.84934.44674,1.68882.923,2.50379,1.42373.82968-.653,1.65937-1.31082,2.48413-1.96374q5.037-3.99134,10.0789-7.97282a62.61957,62.61957,0,0,0-9.11177-4.69823c-.60876-.2553-1.22243-.50568-1.841-.74132A63.01419,63.01419,0,0,0,1.02029,88.343H6.66605a56.291,56.291,0,0,1,5.98942-21.26243A54.66146,54.66146,0,0,1,25.95983,50.30038,52.82753,52.82753,0,0,1,44.09008,40.26073,51.036,51.036,0,0,1,64.00244,38.07609Z"/>
<path d="M126.97971,88.343q0-.61118-.01474-1.22243a4.46871,4.46871,0,0,0,.00983-.51548c-.09819-2.44485-.25038-4.90444-.58913-7.32967a62.08046,62.08046,0,0,0-11.63519-28.46937l-4.59515,6.77q-3.07816,4.53623-6.19561,9.13139a44.62758,44.62758,0,0,1,1.60046,4.42825A44.163,44.163,0,0,1,107.2048,88.343Z"/>
</svg>
`,F=`<svg viewBox="0 0 32 32" fill="none" stroke="currentcolor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
<path d="M2 20 L12 28 30 4" />
</svg>
`,z=`<svg viewBox="-1 -1 34 34" stroke="none" fill="currentcolor" xmlns="http://www.w3.org/2000/svg">
...
`,N=O,H=V,Z=R,G=F,K=z,W={speedUp:N,speedDown:H,jstBlack:Z,checkmark:G,bug:K},f=W;function Y(n,e){return function(){let o=document.createElement("form"),t=document.createElement("button");o.classList.add("JSt-form"),o.innerHTML+=`
    <input
      minlength=6
      maxlength=6
      required
      ...
      placeholder="______"
    ></input>
    `;let s=o.querySelector("#JSt-code-input");return s.value=e(),t.classList.add("JSt-button"),t.innerHTML=f.checkmark,o.onsubmit=r=>{r.preventDefault(),n(s.value)},o.append(t),o}}var w=Y;function Q(n,e){n.innerHTML="",e.forEach(o=>{let t=document.createElement("button");t.classList.add("JSt-button"),n.append(o(t))})}var g=Q;function X(n){let e,o;switch(n.dimensions){case void 0:case"normal":e=75,o=800;break;case"big":e=85,o=900;break;case"verybig":e=100,o=1e3}let t,s,r,i,l,p,c;switch(n.color){case void 0:case"trans":i="#c8c8c8a0",r="#c8c8c8a0",s="#ffffffa0",t="#eeeeeea0",l="#e090df",p="#a44cd3",c="#8800c7";break;case"white":i="#ccd",r="#aaa",s="#fff",t="#bbbbbb",l="#888",p="#555",c="#333";break;case"black":i="#222",r="#333",s="#222222",t="#000",l="#888",p="#555",c="#333";break;case"green":i="#bfa",r="#7a6",s="#bfa",t="#8b7",l="#888",p="#555",c="#333";break;case"pink":i="#fab",r="#a67",s="#fab",t="#b78",l="#888",p="#555",c="#333";break;case"blue":i="#abf",r="#67a",s="#abf",t="#78b",l="#888",p="#555",c="#333";break}let a;switch(n["border-width"]){case void 0:case"4px":a="box-shadow: 0px 0px 10px 4px;";break;case"6px":a="box-shadow: 0px 0px 10px 6px;";break;case"10px":a="box-shadow: 0px 0px 10px 10px;"}let u=.9,d=`
.JSt-video-wrapper {
  display: flex;
  align-items: center;
...
#JSt-pill {
  ...
  border: 2px solid ${r};
  background-image:linear-gradient(${s},${t});
...
#JSt-version {
  ...
  font-size: 0.6rem;
    ...
    `;return function(){let T=document.createElement("style");T.innerHTML=d,document.head.append(T)}}var y=X;function ee(n,e){if(e){let a=document.querySelector("#JSt-pill");if(a&&a.parentNode)a.parentNode.removeChild(a);else return 0;let u=document.querySelector(".JSt-video-wrapper");u&&(u.parentNode.append(u.children.item(0)),u.remove());return}if(!n)throw new Error("couldnt init on undefined elem");if(n.nodeName==="VIDEO"){let a=document.createElement("div");a.classList.add("JSt-video-wrapper"),n.parentNode.appendChild(a);let u=()=>{if(a.requestFullscreen)return a.requestFullscreen();if(a.mozRequestFullScreen)return a.mozRequestFullScreen();if(a.webkitRequestFullScreen)return a.webkitRequestFullScreen()},d=()=>{a.appendChild(n),window.removeEventListener("click",d),window.removeEventListener("keydown",d),setTimeout(u,200)};return window.addEventListener("click",d),window.addEventListener("keydown",d),0}let o=a=>document.createElement(a),t=o("section"),s=o("div"),r=o("p"),i=o("span");t.id="JSt-pill",s.id="JSt-button-container",r.id="JSt-message",i.id="JSt-version",i.innerText=`alpha ${7}`,t.append(s),t.append(r),t.append(i),n.append(t),t.onclick=a=>a.stopPropagation();function l(){t.hidden=!0}let p;function c(){p&&clearTimeout(p),p=setTimeout(l,2e3),t.hidden=!1}return c(),document.addEventListener("click",c),document.addEventListener("mousedown",c),document.addEventListener("mousemove",c),document.addEventListener("keydown",c),[t,s,r]}var J=ee;var k=J;var S=20,te={dimensions:"normal",color:"trans","border-width":"4px"};function P(n,e,o,t){let s=m(f.jstBlack,I(n,e,o,t),a=>a.style.padding=S+"px"),r=m(f.jstBlack,I(n,e,o,t),a=>a.style.padding=S+"px"),i=m(f.speedDown,a=>{t.playbackRate>.25&&(t.playbackRate-=.25)}),l=m(f.speedUp,a=>{t.playbackRate<20&&(t.playbackRate+=.25)}),p=m(f.bug,a=>{window.open("https://jstplayer.com/feedback?from=app","_blank")});return[s,i,l,r,p]}function I(n,e,o,t){return function(r){let[i,l,p,c,a]=P(n,e,o,t),u=[m(f.jstBlack,d=>g(n,[c,l,p,a]),d=>d.style.padding=S+"px"),w(o,e)];g(n,u)}}async function ne(n,e,o,t){let s=k(n);if(!s)return;let[r,i,l]=s,[p,c,a,u,d]=P(i,e,o,t);g(i,[p,c,a,d])}function oe(){k(null,!0)}function j(){let n=y(te),e=document.createElement("script");e.src="https://cdn.socket.io/4.3.2/socket.io.min.js",e.crossorigin="anonymous",e.onerror=e.onload=t=>_("symwatch.herokuapp.com",n,ne,oe),document.body.append(e),[...document.querySelectorAll("iframe")].forEach(t=>{let s=t.getBoundingClientRect();if(s.width===0||s.height===0)return;console.log(s);let r=document.createElement("button");r.style.position="absolute",r.style.top=s.top,r.style.left=s.left,r.style.width=s.width,r.style.height=s.height,r.onclick=i=>{window.open(t.src),i.stopPropagation()},r.oncontextmenu=i=>(i.preventDefault(),r.remove(),!1),r.style.background="transparent",r.style.border="2px solid #e090df",r.style.boxShadow="0 0 10px 4px #e090df",t.parentElement.append(r),console.log(t)}),console.log("started")}j();var Me=j;})();
