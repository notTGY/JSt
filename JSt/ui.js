(()=>{function R(n){let e,t;switch(n.dimensions){case void 0:case"normal":e=75,t=800;break;case"big":e=85,t=900;break;case"verybig":e=100,t=1e3}let r,s,c,o,a,i,l;switch(n.color){case void 0:case"trans":o="#c8c8c8a0",c="#c8c8c8a0",s="#ffffffa0",r="#eeeeeea0",a="#e090df",i="#a44cd3",l="#8800c7";break;case"white":o="#ccd",c="#aaa",s="#fff",r="#bbbbbb",a="#888",i="#555",l="#333";break;case"black":o="#222",c="#333",s="#222222",r="#000",a="#888",i="#555",l="#333";break;case"green":o="#bfa",c="#7a6",s="#bfa",r="#8b7",a="#888",i="#555",l="#333";break;case"pink":o="#fab",c="#a67",s="#fab",r="#b78",a="#888",i="#555",l="#333";break;case"blue":o="#abf",c="#67a",s="#abf",r="#78b",a="#888",i="#555",l="#333";break}let d;switch(n["border-width"]){case void 0:case"4px":d="box-shadow: 0px 0px 10px 4px;";break;case"6px":d="box-shadow: 0px 0px 10px 6px;";break;case"10px":d="box-shadow: 0px 0px 10px 10px;"}let p=.9,u=`
.JSt-video-wrapper {
  display: flex;
  align-items: center;
...
#JSt-pill {
  ...
  border: 2px solid ${c};
  background-image:linear-gradient(${s},${r});
...
`,h=document.createElement("style");h.innerHTML=u,document.head.append(h)}var y=R;var V=`<svg viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,j=`<svg viewBox="0 0 32 32" fill="none" stroke="currentcolor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2">
...
`,D=I,F=N,P=V,z=j,U=B,Z={speedUp:D,speedDown:F,jstBlack:P,checkmark:z,bug:U},f=Z;function b(){[...document.querySelectorAll("iframe")].forEach(e=>{let t=e.getBoundingClientRect();if(t&&t.width&&t.height){let r=document.createElement("button");r.classList="JSt-iframe-button",r.style.top=t.top,r.style.left=t.left,r.style.width=t.width,r.style.height=t.height,r.onclick=s=>{window.open(e.src),s.stopPropagation()},r.oncontextmenu=s=>(s.preventDefault(),r.remove(),0),e.parentElement.append(r)}})}function L(n){let e=n.querySelector("video");if(e)return e;let t=document.body.querySelectorAll("video"),r=document.querySelector("audio");return r||t[0]}function v(n){let e=document.querySelector("audio");if(e)return n(e);["fullscreenchange","webkitfullscreenchange","mozfullscreenchange","MSFullscreenChange"].forEach(t=>document.addEventListener(t,n))}function w(n,e){!n||["playing","pause","ratechange","seeked"].forEach(t=>{n.addEventListener(t,e)})}var C=0;function E(n){return n.currentTime>0&&!n.paused&&!n.ended&&n.readyState>2}function k(n){let e=new Date().getTime();if(e-C<100)return!1;C=e;let t=e,r=E(n),s=n.currentTime,c=n.playbackRate,o={playing:r,vidCurTime:s,curTime:t,playbackRate:c};return JSON.stringify(o)}function J(n,e){let{vidCurTime:t,playbackRate:r,curTime:s,playing:c}=n;if(!s||s<C)return;let o=new Date().getTime();C=o;let a=(o-s)/1e3,i=t+r*a,l=E(e);c?(Math.abs(e.currentTime-i)>500&&(e.currentTime=i),l||(e.play(),e.currentTime!==i&&(e.currentTime=i))):(e.currentTime!==t&&(e.currentTime=t),l&&e.pause()),e.playbackRate!==n.playbackRate&&(e.playbackRate=n.playbackRate)}var H=(n,e)=>{let t=[],r=()=>{let c=e();if(!Array.isArray(c))return console.error("jstf expects an Array as a vdom");n.innerHTML="",n.append(s(t,c)),t=c},s=(c,o)=>{Array.isArray(o)&&(o={children:o}),typeof o=="string"&&(o={text:o}),o.elem=o.elem||"div",!c||c.elem!==o.elem?o.$el=document.createElement(o.elem):(o.$el=c.$el,o.cleanup=c.cleanup);let{$el:a,elem:i,text:l,value:d,className:p,children:u,...h}=o,g=m=>typeof m<"u";if(g(l)&&(a.innerHTML=l),g(d)&&(a.value=d),g(p)&&(a.className=p),u&&a.append(...u.map((m,x)=>s(c&&c.children&&c.children[x],m))),o.cleanup)for(let m in o.cleanup)a.removeEventListener(m,o.cleanup[m]);o.cleanup={};for(let m in h)a.addEventListener(m,o.cleanup[m]=x=>{h[m](x),r()});return a};return r(),r},$=H;function S(n,e,t){let r=()=>({elem:"button",className:"JSt-button",text:f.speedUp,click:u=>{t.playbackRate<20&&(t.playbackRate+=.25)}}),s=()=>({elem:"button",className:"JSt-button",text:f.speedDown,click:u=>{t.playbackRate>.25&&(t.playbackRate-=.25)}}),c=()=>({elem:"button",className:"JSt-button",text:f.bug,click:u=>{window.open("https://jstplayer.com/feedback?from=app","_blank")}}),o=()=>({elem:"form",className:"JSt-form",submit:u=>{u.preventDefault(),e(document.querySelector("#JSt-code-input").value.toUpperCase())},text:`
        <input
          minlength=6
          maxlength=6
          required
          ...
          value=${n()??""}
        ></input>
      `,children:[{elem:"button",className:"JSt-button",text:f.checkmark}]}),a="default",i=()=>({elem:"button",className:"JSt-button JSt-button-padding",text:f.jstBlack,click:u=>{a==="default"?a="code":a==="code"&&(a="default")}}),l=()=>{switch(a){case"default":return[i(),s(),r(),c()];case"code":return[i(),o()]}},d=()=>[{elem:"div",className:"JSt-button-container",children:l()},{elem:"span",className:"JSt-version",text:`alpha ${14}`}],p=$(document.querySelector("#JSt-pill"),d)}var G=2e3;function T(n,e,t,r){if(!n)throw new Error("couldnt init on undefined elem");if(n.nodeName==="VIDEO"){let i=document.createElement("div");i.classList.add("JSt-video-wrapper"),n.parentNode.appendChild(i);let l=()=>{if(i.requestFullscreen)return i.requestFullscreen();if(i.mozRequestFullScreen)return i.mozRequestFullScreen();if(i.webkitRequestFullScreen)return i.webkitRequestFullScreen()},d=()=>{!i||(i.appendChild(n),window.removeEventListener("click",d),window.removeEventListener("keydown",d),setTimeout(l,200))};return window.addEventListener("click",d),window.addEventListener("keydown",d),0}let s=document.createElement("section");s.id="JSt-pill",n.append(s),s.onclick=i=>i.stopPropagation();function c(){s.hidden=!0}let o;function a(){o&&clearTimeout(o),o=setTimeout(c,G),s.hidden=!1}a(),document.addEventListener("click",a),document.addEventListener("mousedown",a),document.addEventListener("mousemove",a),document.addEventListener("keydown",a),S(e,t,r)}function M(){let n=document.querySelector("#JSt-pill");if(n&&n.parentNode)n.parentNode.removeChild(n);else return 0;let e=document.querySelector(".JSt-video-wrapper");e&&(e.parentNode.append(e.children.item(0)),e.remove())}function _(n){let e=null,t=null,r=null,s=()=>r;return{onIncomingMessage(c){J(c,t)},connectPort(c){if(e=c,window.JST)return;window.JST=1,y(n),b(),v(a=>{let i=document.querySelector("audio"),l;if(i)t=i,l=document.body;else{if(l=document.fullscreenElement,!l)return M();t=L(l)}w(t,()=>e.postMessage({roomId:r,data:k(t)})),T(l,s,p=>{r=p,w(t,()=>e.postMessage({roomId:r,data:k(t)}))},t)})}}}var O={dimensions:"normal",color:"trans","border-width":"4px"},q=_(O),A=chrome.runtime.connect({name:"jst"});A.onMessage.addListener(q.onIncomingMessage);q.connectPort(A);})();
