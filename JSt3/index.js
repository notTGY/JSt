(()=>{function C(n,e){!n||["playing","pause","ratechange","seeked"].forEach(o=>{n.addEventListener(o,e)})}function T(n){let e=n.querySelector("video");if(e)return e;let o=document.body.querySelectorAll("video"),t=document.querySelector("audio");return t||o[0]}function $(n){let e=document.querySelector("audio");if(e)return n(e);["fullscreenchange","webkitfullscreenchange","mozfullscreenchange","MSFullscreenChange"].forEach(o=>document.addEventListener(o,n))}var x=0;function v(n){return n.currentTime>0&&!n.paused&&!n.ended&&n.readyState>2}function w(n){let e=new Date().getTime();if(e-x<100)return!1;x=e;let o=e,t=v(n),i=n.currentTime,s=n.playbackRate,r={playing:t,vidCurTime:i,curTime:o,playbackRate:s};return JSON.stringify(r)}function y(n,e){let{vidCurTime:o,playbackRate:t,curTime:i,playing:s}=n;if(!i||i<x)return;let r=new Date().getTime();x=r;let p=(r-i)/1e3,l=o+t*p,c=v(e);s?(Math.abs(e.currentTime-l)>500&&(e.currentTime=l),c||(e.play(),e.currentTime!==l&&(e.currentTime=l))):(e.currentTime!==o&&(e.currentTime=o),c&&e.pause()),e.playbackRate!==n.playbackRate&&(e.playbackRate=n.playbackRate)}var I=5e3,E="https";async function j(n){let e;function o(t,i){if(!i||!t)return r=>r;let s=i.toUpperCase();return e&&clearInterval(e),e=setInterval(()=>{fetch(`${E}://${n}/?method=get&room=${s}`).then(r=>r.json()).then(r=>y(r,t))},I),r=>{let p=w(t);p&&fetch(`${E}://${n}/?method=send&room=${s}&data=${p}`)}}try{let i=function(s,r){if(!r||!s)return c=>c;let p=r.toUpperCase(),l=0;return t.on("message",c=>{y(JSON.parse(c),s)}),c=>{let a=w(s);a&&t.send(`${p} ${a}`)}},t=await io(`https://${n}/`);return i}catch(t){return console.log(t),o}}var B=j;async function P(n,e,o,t){if(window.JST_INITED)return;window.JST_INITED=!0,e();let i=await B(n),s=null,r=null,p=c=>{s=c;let a=i(r,s);C(r,a)};$(c=>{let a=document.querySelector("audio");if(a){let u=i(a,s);C(a,u),r=a,o(document.body,p,a)}else{let u=document.fullscreenElement;if(!u)return t();r=T(u);let m=i(r,s);C(r,m),o(u,p,r)}})}var J=P;function A(n="",e=t=>t,o=t=>t){return t=>(t.innerHTML=n,t.onclick=e,o(t),t)}var f=A;var q=`<svg viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,O=V,z=R,F=q,N=D,H=U,Z={speedUp:O,speedDown:z,jstBlack:F,checkmark:N,bug:H},d=Z;function G(n){return function(){let e=document.createElement("form"),o=document.createElement("button");return e.classList.add("JSt-form"),e.innerHTML+=`
    <input
      minlength=6
      maxlength=6
      required
      ...
      placeholder="______"
    ></input>
    `,o.classList.add("JSt-button"),o.innerHTML=d.checkmark,e.onsubmit=t=>{t.preventDefault();let i=e.querySelector("#JSt-code-input");n(i.value)},e.append(o),e}}var k=G;function K(n,e){n.innerHTML="",e.forEach(o=>{let t=document.createElement("button");t.classList.add("JSt-button"),n.append(o(t))})}var g=K;function W(n){let e,o;switch(n.dimensions){case void 0:case"normal":e=75,o=800;break;case"big":e=85,o=900;break;case"verybig":e=100,o=1e3}let t,i,s,r;switch(n.color){case void 0:case"white":r="#ccd",s="#aaa",i="#fff",t="#bbbbbb";break;case"black":r="#222",s="#333",i="#222222",t="#000";break;case"green":r="#bfa",s="#7a6",i="#bfa",t="#8b7";break;case"pink":r="#fab",s="#a67",i="#fab",t="#b78";break;case"blue":r="#abf",s="#67a",i="#abf",t="#78b";break}let p;switch(n["border-width"]){case void 0:case"4px":p="box-shadow: 0px 0px 10px 4px;";break;case"6px":p="box-shadow: 0px 0px 10px 6px;";break;case"10px":p="box-shadow: 0px 0px 10px 10px;"}let l=.9,c=`
.JSt-video-wrapper {
  display: flex;
  align-items: center;
...
#JSt-version {
  ...
  font-size: 0.6rem;
    ...
    `;return function(){let u=document.createElement("style");u.innerHTML=c,document.head.append(u)}}var L=W;function Y(n,e){if(e){let a=document.querySelector("#JSt-pill");if(a&&a.parentNode)a.parentNode.removeChild(a);else return 0;let u=document.querySelector(".JSt-video-wrapper");u&&(u.parentNode.append(u.children.item(0)),u.remove());return}if(!n)throw new Error("couldnt init on undefined elem");if(n.nodeName==="VIDEO"){let a=document.createElement("div");a.classList.add("JSt-video-wrapper"),n.parentNode.appendChild(a);let u=()=>{if(a.requestFullscreen)return a.requestFullscreen();if(a.mozRequestFullScreen)return a.mozRequestFullScreen();if(a.webkitRequestFullScreen)return a.webkitRequestFullScreen()},m=()=>{a.appendChild(n),window.removeEventListener("click",m),window.removeEventListener("keydown",m),setTimeout(u,200)};return window.addEventListener("click",m),window.addEventListener("keydown",m),0}let o=a=>document.createElement(a),t=o("section"),i=o("div"),s=o("p"),r=o("span");t.id="JSt-pill",i.id="JSt-button-container",s.id="JSt-message",r.id="JSt-version",r.innerText=`alpha ${1}`,t.append(i),t.append(s),t.append(r),n.append(t),t.onclick=a=>a.stopPropagation();function p(){t.hidden=!0}let l;function c(){l&&clearTimeout(l),l=setTimeout(p,2e3),t.hidden=!1}return c(),document.addEventListener("click",c),document.addEventListener("mousemove",c),document.addEventListener("keydown",c),[t,i,s]}var b=Y;var S=20,Q={dimensions:"normal",color:"white","border-width":"4px"};function _(n,e,o){let t=f(d.jstBlack,M(n,e,o),c=>c.style.padding=S+"px"),i=f(d.jstBlack,M(n,e,o),c=>c.style.padding=S+"px"),s=f(d.speedDown,c=>{o.playbackRate>.25&&(o.playbackRate-=.25)}),r=f(d.speedUp,c=>{o.playbackRate<20&&(o.playbackRate+=.25)}),p=f(d.bug,c=>{window.open("https://jstplayer.com/feedback?from=app","_blank")});return[t,s,r,i,p]}function M(n,e,o){return function(i){let[s,r,p,l,c]=_(n,e,o),a=[f(d.jstBlack,u=>g(n,[l,r,p,c]),u=>u.style.padding=S+"px"),k(e)];g(n,a)}}async function X(n,e,o){let t=b(n);if(!t)return;let[i,s,r]=t,[p,l,c,a,u]=_(s,e,o);g(s,[p,l,c,u])}function ee(){b(null,!0)}var te=L(Q),h=document.createElement("script");h.src="https://cdn.socket.io/4.3.2/socket.io.min.js";h.crossorigin="anonymous";h.onerror=h.onload=n=>J("symwatch.herokuapp.com",te,X,ee);document.body.append(h);})();
