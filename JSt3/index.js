(()=>{function w(n,e){!n||["playing","pause","ratechange","seeked"].forEach(o=>n.addEventListener(o,e))}function T(n){let e=n.querySelector("video");if(e)return e;let o=document.body.querySelectorAll("video");if(o.length<1)throw new Error("haven't found any videos");return o[0]}function $(n){["fullscreenchange","webkitfullscreenchange","mozfullscreenchange","MSFullscreenChange"].forEach(e=>document.addEventListener(e,n))}var C=0;function v(n){return n.currentTime>0&&!n.paused&&!n.ended&&n.readyState>2}function b(n){let e=new Date().getTime();if(e-C<100)return!1;C=e;let o=e,t=v(n),i=n.currentTime,a=n.playbackRate,r={playing:t,vidCurTime:i,curTime:o,playbackRate:a};return JSON.stringify(r)}function y(n,e){let{vidCurTime:o,playbackRate:t,curTime:i,playing:a}=n;if(!i||i<C)return;let r=new Date().getTime();C=r;let l=(r-i)/1e3,p=o+t*l,c=v(e);a?(Math.abs(e.currentTime-p)>500&&(e.currentTime=p),c||(e.play(),e.currentTime!==p&&(e.currentTime=p))):(e.currentTime!==o&&(e.currentTime=o),c&&e.pause()),e.playbackRate!==n.playbackRate&&(e.playbackRate=n.playbackRate)}var I=5e3,E="https";async function j(n){let e;function o(t,i){if(!i||!t)return r=>r;let a=i.toUpperCase();return e&&clearInterval(e),e=setInterval(()=>{fetch(`${E}://${n}/?method=get&room=${a}`).then(r=>r.json()).then(r=>y(r,t))},I),r=>{let l=b(t);l&&fetch(`${E}://${n}/?method=send&room=${a}&data=${l}`)}}try{let i=function(a,r){if(!r||!a)return c=>c;let l=r.toUpperCase(),p=0;return t.on("message",c=>{y(JSON.parse(c),a)}),c=>{let s=b(a);s&&t.send(`${l} ${s}`)}},t=await io(`https://${n}/`);return i}catch(t){return console.log(t),o}}var B=j;async function P(n,e,o,t){if(window.JST_INITED)return;window.JST_INITED=!0,e();let i=await B(n),a=null,r=null,l=c=>{a=c;let s=i(r,a);w(r,s)};$(c=>{let s=document.fullscreenElement;if(!s)return t();r=T(s);let d=i(r,a);w(r,d),o(s,l,r)})}var J=P;function A(n="",e=t=>t,o=t=>t){return t=>(t.innerHTML=n,t.onclick=e,o(t),t)}var f=A;var R=`<svg viewBox="0 0 42 42" fill="none" xmlns="http://www.w3.org/2000/svg">
...
`,U=`<svg viewBox="-1 -1 34 34" stroke="none" fill="currentcolor" xmlns="http://www.w3.org/2000/svg">
...
`,O=q,z=V,F=R,N=D,H=U,Z={speedUp:O,speedDown:z,jstBlack:F,checkmark:N,bug:H},u=Z;function G(n){return function(){let e=document.createElement("form"),o=document.createElement("button");return e.classList.add("JSt-form"),e.innerHTML+=`
    <input
      minlength=6
      maxlength=6
      required
      ...
      placeholder="______"
    ></input>
    `,o.classList.add("JSt-button"),o.innerHTML=u.checkmark,e.onsubmit=t=>{t.preventDefault();let i=e.querySelector("#JSt-code-input");n(i.value)},e.append(o),e}}var k=G;function K(n,e){n.innerHTML="",e.forEach(o=>{let t=document.createElement("button");t.classList.add("JSt-button"),n.append(o(t))})}var m=K;function W(n){let e,o;switch(n.dimensions){case void 0:case"normal":e=75,o=800;break;case"big":e=85,o=900;break;case"verybig":e=100,o=1e3}let t,i,a,r;switch(n.color){case void 0:case"white":r="#ccd",a="#aaa",i="#fff",t="#bbbbbb";break;case"black":r="#222",a="#333",i="#222222",t="#000";break;case"green":r="#bfa",a="#7a6",i="#bfa",t="#8b7";break;case"pink":r="#fab",a="#a67",i="#fab",t="#b78";break;case"blue":r="#abf",a="#67a",i="#abf",t="#78b";break}let l;switch(n["border-width"]){case void 0:case"4px":l="box-shadow: 0px 0px 10px 4px;";break;case"6px":l="box-shadow: 0px 0px 10px 6px;";break;case"10px":l="box-shadow: 0px 0px 10px 10px;"}let p=.9,c=`
.JSt-video-wrapper {
  display: flex;
  align-items: center;
...
#JSt-version {
  ...
  font-size: 0.6rem;
    ...
    `;return function(){let d=document.createElement("style");d.innerHTML=c,document.head.append(d)}}var L=W;function Y(n,e){if(e){let s=document.querySelector("#JSt-pill");if(s&&s.parentNode)s.parentNode.removeChild(s);else return 0;let d=document.querySelector(".JSt-video-wrapper");d&&(d.parentNode.append(d.children.item(0)),d.remove());return}if(!n)throw new Error("couldnt init on undefined elem");if(n.nodeName==="VIDEO"){let s=document.createElement("div");s.classList.add("JSt-video-wrapper"),n.parentNode.appendChild(s);let d=()=>{if(s.requestFullscreen)return s.requestFullscreen();if(s.mozRequestFullScreen)return s.mozRequestFullScreen();if(s.webkitRequestFullScreen)return s.webkitRequestFullScreen()},g=()=>{s.appendChild(n),window.removeEventListener("click",g),window.removeEventListener("keydown",g),setTimeout(d,200)};return window.addEventListener("click",g),window.addEventListener("keydown",g),0}let o=s=>document.createElement(s),t=o("section"),i=o("div"),a=o("p"),r=o("span");t.id="JSt-pill",i.id="JSt-button-container",a.id="JSt-message",r.id="JSt-version",r.innerText=`alpha ${2}`,t.append(i),t.append(a),t.append(r),n.append(t),t.onclick=s=>s.stopPropagation();function l(){t.hidden=!0}let p;function c(){p&&clearTimeout(p),p=setTimeout(l,2e3),t.hidden=!1}return c(),document.addEventListener("click",c),document.addEventListener("mousemove",c),document.addEventListener("keydown",c),[t,i,a]}var x=Y;var S=20,Q={dimensions:"normal",color:"white","border-width":"4px"};function _(n,e,o){let t=f(u.jstBlack,M(n,e,o),c=>c.style.padding=S+"px"),i=f(u.jstBlack,M(n,e,o),c=>c.style.padding=S+"px"),a=f(u.speedDown,c=>{o.playbackRate>.25&&(o.playbackRate-=.25)}),r=f(u.speedUp,c=>{o.playbackRate<20&&(o.playbackRate+=.25)}),l=f(u.bug,c=>{window.open("https://jstplayer.com/feedback?from=app","_blank")});return[t,a,r,i,l]}function M(n,e,o){return function(i){let[a,r,l,p,c]=_(n,e,o),s=[f(u.jstBlack,d=>m(n,[p,r,l,c]),d=>d.style.padding=S+"px"),k(e)];m(n,s)}}async function X(n,e,o){let t=x(n);if(!t)return;let[i,a,r]=t,[l,p,c,s,d]=_(a,e,o);m(a,[l,p,c,d])}function e1(){x(null,!0)}var t1=L(Q),h=document.createElement("script");h.src="https://cdn.socket.io/4.3.2/socket.io.min.js";h.crossorigin="anonymous";h.onerror=h.onload=n=>J("symwatch.herokuapp.com",t1,X,e1);document.body.append(h);})();
